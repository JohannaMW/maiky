...
urlpatterns = patterns('',
    ...
    url(r'^opera/schnitzlers-dreams', 'portfolio.views.sd', name='sd'),
    ...
    url(r'^film/two-people', 'portfolio.views.two_people', name='two_people'),
    url(r'^film/ikke-helt-alene', 'portfolio.views.ikke', name='ikke'),
    ...
    url(r'^theatre/smallhouse', 'portfolio.views.smallhouse', name='smallhouse'),
    url(r'^theatre', 'portfolio.views.theatre', name='theatre'),
    url(r'^dance/kylmae', 'portfolio.views.kylma', name='kylma'),
    url(r'^dance/women', 'portfolio.views.women', name='women'),
